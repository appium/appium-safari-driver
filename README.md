...
acceptInsecureCerts | Makes the browser to ignore the appropriate security warning and thus allows navigation to we sites having invalid or expired TLS certificates. The capability is supported since safaridriver v15.4.
