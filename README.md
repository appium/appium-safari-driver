...
acceptInsecureCerts | safaridriver will accept navigating to an expired or invalid TLS certificate website. safaridriver 15.4 and the above support the capability.
